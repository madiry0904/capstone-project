...
const lowStress30 = [
  "Count your breaths! Research has demonstrated that the way you breathe affects your entire body so take one minute and shut down all electronics, close your eyes, and count 10 deeps breaths making sure to count the number on each exhale.",
  ...
  "Try some supplements! Since you're short on time let's get straight to the point and try using a  stress reducing supplements such as Ashwaganda. Ashwagandha is an Asian herbal supplement used in traditional medicine to treat anxiety and help people adapt to stress. For more information on Ashwaganda click <a href= 'https://examine.com/supplements/ashwagandha/'>this</a> link!"
];
const lowStress45 = [
  "Meditation is a powerful tool in combatting stress! meditation helps clear away the information overload that build pu every day and contributes to stress. You don't have to meditate teh entire 45 minutes but do as mich as you can! If you're new to meditation and would prefer a guided class click <a href= 'https://www.youtube.com/watch?v=rdW2pM0DyYQ'>this</a> guided meditation.",
  ...
  "Get Stretchy! Yoga has consistently proven to be one of the most effective stress reduction techniques (which is why you will find it at different points in this quiz!). To make it easy and accessible for everyone follow <a href= 'https://www.youtube.com/watch?v=RcGyVTAoXEU'>this</a> link for an easy chair yoga routine for stress reduction!"
];
const lowStress60 = [
  "Unplug! The American Psychological Association found that nearly 1/5 of people identified technology as a major source of stress. For one hour I want you to leave all technology behind and get outside for a walk, run, or even to sit on a bench as long as your phone isn't with you!",

  "Journal about what you're feeling! Sometimes the only way to get out of our head is to get it all down with the old fashioned pen and paper technique NO ELECTRONICS. This may help you clarify your thought patterns and feelings to explore and release certain emotions you're having.",
...
const midStress30 = [
  "Get Stretchy! Since you're short on time try <a href= 'https://www.youtube.com/watch?v=OC_dvBnRKn4&t=282s'>this</a> quick 30 minute feel good yoga sequence to help lower stress levels",
  "Watch <a href= 'https://www.youtube.com/watch?v=RcGyVTAoXEU'>this</a> Ted Talk on stress management",
  "Gratitude Journal! When things feel crazy and overwhelming it's important to get back to your center and remember all that you have. Make a gratitude list of 10 things you're grateful for in this moment!"
];
...
const midStress60 = [
  "Get in Nature! Put your phone down, get outside and go for a walk or hike but all we ask is that you do not use any technology!",
...
const highStress60 = [
  "Expand your Social Circle! When you're stress you can feel isolated and like you're the only one feeling this way when in reality it. Put yourself out there and attend a meet up to expand your social circle and get out of your head!",
